...
DROP DATABASE IF EXISTS FinalJavaAdvance;
-- Create database
CREATE DATABASE IF NOT EXISTS FinalJavaAdvance;
USE FinalJavaAdvance;
...
CREATE TABLE IF NOT EXISTS `Department` (
    ...
    `type`					ENUM('Dev','Test','Scrum_Master','PM','Bridge_SE') NOT NULL,
...
VALUES
						(N'Marketing'	, 		3,		'Dev', 			'2020-03-05'),
						(N'Sale'		, 		3,		'Test', 		'2020-03-05'),
						(N'Bảo vệ'		, 		0,		'Scrum_Master', 	'2020-03-07'),
						(N'Nhân sự'		, 		1,		'PM', 			'2020-03-08'),
						(N'Kỹ thuật'	, 		1,		'Dev', 			'2020-03-10'),
                        ...
                        (N'Chiến lược'	, 		7,		'Bridge_SE', 			'2020-09-14');
...
VALUES 				(	'dangblack'		,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Nguyen'	,	'Hai Dang'	,		'ADMIN'		,		'5'			),
                    ...
                    (	'phantombmt'	,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Tran'		,	'Antony'	,		'MANAGER'	,		'11'		),
                    (	'reelun'	,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Tran'		,	'Academy'	,		'MANAGER'	,		'4'		);